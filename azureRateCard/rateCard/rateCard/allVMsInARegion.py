...
def processJsonAndCreateCSV(inputFileName, outputFileName):
    ...
    inputFileName := full path name of the JSON file that should've been
    downloaded before executing this script
    outputFileName := full path name of the CSV file that is created as a
    result of execution of this code
    """
    counter = 0
    ...
    dfOut = dfOut[['name', 'numberOfCores', 'memoryInMb', 'maxDataDiskCount',
                   'osDiskSizeInMb', 'resourceDiskSizeInMb']]
